    ...
    <main className="grid min-h-screen place-items-center bg-gradient-to-b from-brand-50 to-white p-4 dark:from-slate-950 dark:to-slate-900">
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={submit} className="rounded-[2rem] bg-white p-7 shadow-soft ring-1 ring-brand-100">
          <p className="text-xs font-black tracking-[.16em] text-brand-600">ACESSO eSTACIONA</p>
          <h1 className="mt-2 text-3xl font-black">Bem-vindo</h1>
          <p className="mt-2 text-slate-500">Acesse a operação do seu estacionamento.</p>
          ...
          >
            {loading ? 'Entrando...' : 'Entrar no eStaciona'}
          </button>
        </form>
        <p className="mt-5 text-center text-xs font-semibold text-slate-400">
          O controle do seu pátio na palma da mão.
        </p>
      </div>
    </main>
  );
